...
const images = [
    ...
    { src: 'images/galleryImg/img3.png', description: '작년 프로젝트 타이틀 김여주 (초기)' },
    { src: 'images/galleryImg/img4.png', description: '작년 프로젝트 타이틀 김여주 (확정)' },
    { src: 'images/galleryImg/img5.png', description: '? 엔딩 초기 시안' },
    { src: 'images/galleryImg/img6.gif', description: '작년 프로젝트 로딩 gif' },
    { src: 'images/galleryImg/img7.png', description: '장미고 로고' },
    { src: 'images/galleryImg/img8.png', description: '작년 프로젝트 로고' },
    { src: 'images/galleryImg/img9.png', description: '? 엔딩 초기 시안' },
    { src: 'images/galleryImg/img10.png', description: '? 엔딩 초기 시안' },
    { src: 'images/galleryImg/img11.png', description: '작년 프로젝트 메인화면' },
